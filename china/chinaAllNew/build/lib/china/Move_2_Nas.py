...
class Move2Nas(object):
    ...
    def Move2NasMain(self):
        ...
        dir_list = os.listdir("/data/OPDCMS/china/report_data_update/pdf")
        for temp in dir_list:
            ...
            try:
                ...
                pass
            self.num += 1
            self.uploadfile(ftp, "/homes/China/" + fiscal_year + "/" + temp, "/data/OPDCMS/china/report_data_update/pdf/" + temp)
