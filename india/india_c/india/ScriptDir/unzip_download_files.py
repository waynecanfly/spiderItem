...
class Decompression(object):
    ...
    def get_file_name(self):
        """获取文件名"""
        path = "D:\item\OPDCMS\listed company update\india\data\pdf"
        dir_list = os.listdir("D:\item\OPDCMS\listed company update\india\data\zip")
        for temp in dir_list:
            self.num += 1
            print("正在解压第%s个" % self.num)
            zip_name = "D:\item\OPDCMS\listed company update\india\data\zip/" + temp
