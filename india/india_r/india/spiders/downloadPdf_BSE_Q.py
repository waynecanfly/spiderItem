...
class CompanylistSpider(scrapy.Spider):
    ...
    page = 0
    nowdate = str(time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time()))).split(" ")[0].replace("-", "")
    # nowdate = "20181207"
    ...
    # url1 = "https://www.bseindia.com/corporates/ann.aspx?curpg=1&annflag=1&dt=20070101&dur=P&dtto=20181206&cat=&scrip="
    # url2 = "&anntype=C"

    # url1 = "https://www.bseindia.com/corporates/ann.aspx?curpg=1&annflag=1&dt=20180101&dur=P&dtto=20181206&cat=&scrip="
    # url2 = "&anntype=C"

    url1 = "https://www.bseindia.com/corporates/ann.aspx?curpg=1&annflag=1&dt="
    url2 = "&dur=D&dtto=&cat=&scrip="
    url3 = "&anntype=C"
    ...
    def start_requests(self):
        for temp in self.results:
            ...
            url = self.url1 + self.nowdate + self.url2 + str(code) + self.url3
    ...
    def parse(self, response):
        ...
        for temp in data_list:
            ...
            if len(pdf_url) == 0:
                ...
                item["doc_local_path"] = "/volume3/homes3/India/" + fiscal_year + "/" + item["report_id"] + ".pdf"
