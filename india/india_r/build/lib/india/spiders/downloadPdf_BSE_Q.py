...
class CompanylistSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for temp in self.results:
            ...
            report_id_list = []
            sql_jud = 'select report_id from financial_statement_index where country_code = "IND" and exchange_market_code = "BSE" and doc_type = "pdf" and company_code = %s'
    ...
    def parse(self, response):
        ...
        if len(page_link) != 0:
            ...
            yield scrapy.Request(url, callback=self.parse, meta={"code": code, "company_id": company_id, "report_id_list": report_id_list})
